...
* 이 프로젝트는 [ALL TV](https://github.com/PYTHONKOR/alltv) 에서 fork 된 프로젝트입니다. Allive 개발자는 ALLTV v1.5 부터 코드를 기여하고 있었으나 코드를 공개하는데 민감한 부분이 있어서 별도 프로젝트로 전환합니다(Allive 개발자는 WAVVE 와 TVING 과 아무런 관련이 없는 순수한 개인 개발자입니다). 
